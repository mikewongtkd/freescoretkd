package FreeScore::Forms::Para::Method::Cutoff;
use FreeScore;
use FreeScore::Forms::Para::Division::Round;
use List::Util qw( shuffle reduce );
use base qw( FreeScore::Forms::Para::Method );
...
#*
	...
	@$placement = sort {
		...
		if( $comparison == 0 ) { $comparison = FreeScore::Forms::Para::Division::Round::_tiebreaker( $x, $y ); }
