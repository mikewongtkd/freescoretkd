...
<div class="scores">
  ...
  <div class="technical">
    ...
    <div class="btn-group difficulty">
      <button class="btn btn-default">3.0</button>
      <button class="btn btn-default">2.8</button>
      <button class="btn btn-default">2.6</button>
      <button class="btn btn-default">2.4</button>
      <button class="btn btn-default">2.2</button>
      <button class="btn btn-default">2.0</button>
      <button class="btn btn-default">1.8</button>
      <button class="btn btn-default">1.6</button>
      <button class="btn btn-default">1.4</button>
  ...
  <div class="presentation">
    ...
    <div class="btn-group technique">
      ...
      <button class="btn btn-default">0.7</button>
      <button class="btn btn-default">0.6</button>
...
<a class="btn btn-success btn-send">Send</a>
