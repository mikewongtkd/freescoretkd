...
<html>
	<head>
		<title>Creative Breaking Divisions</title>
		...
		<script>
			$( function() {
				...
				$('#elfinder').elfinder({
					url : '../../include/opt/elfinder/php/connector.breaking.php',  // connector URL (REQUIRED)
	...
	<body>
		<div class="container">
			<h1>Edit Creative Breaking Divisions</h1>

			<p>You can drag-and-drop ring folders with divisions in them into the <b>feats-breaking</b> directory. You can also drag-and-drop from FreeScore TKD to your computer. Use the buttons to edit the rings and divisions.</p>
			...
			<div class="panel panel-primary">
				<div class="panel-heading">
					...
					<h4 class="panel-title">Creative Breaking Rings and Divisions</h4>
				</div>
