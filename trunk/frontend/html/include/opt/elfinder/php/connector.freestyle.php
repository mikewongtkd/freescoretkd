...
$opts = array(
	...
	'roots' => array(
		array(
			...
			'path'          => '/usr/local/freescore/data/test/forms-freestyle', // path to files (REQUIRED)
			'URL'           => dirname($_SERVER['PHP_SELF']) . '/../../../../forms/freestyle/division/editor.php?file=' . $tournament[ 'db' ] . '/forms-freestyle', // URL to files (REQUIRED)
			...
			'attributes'    => [
				[ 'pattern' => '/progress.txt/', 'read' => false, 'write' => false, 'locked' => true, 'hidden' => true ]
			]
		)
	)
);
