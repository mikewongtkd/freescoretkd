				...
				actions : function( division ) {
					...
					var action = {
						penalty : {
							...
							send       : () => { app.network.send({ type : 'division', action : 'award penalty', penalties: athlete.penalties( round, form )}); },
						...
						decision : {
							...
							send       : ( reason ) => { app.network.send({ type : 'division', action : 'award punitive', decision: reason }); }
						},
					};
