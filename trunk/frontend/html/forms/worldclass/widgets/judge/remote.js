FreeScore.Widget.Remote = class FSWidgetRemote extends FreeScore.Widget {
	constructor( app, dom ) {
		...
		<div class="navigate">
			...
			<div class="btn-navigate prev round" data-type="division" data-action="round prev" data-sound="prev">1<sup>st</sup></div><div class="btn-navigate next round" data-type="division" data-action="round next" data-sound="next">2<sup>nd</sup></div>

			<div class="navigate-label form-label">Division</div>
			<div class="btn-navigate prev division" data-type="ring" data-action="division prev" data-sound="prev">1<sup>st</sup></div><div class="btn-navigate next division" data-type="ring" data-action="division next" data-sound="next">2<sup>nd</sup></div>
